...
void print_usage( string prog ){
  cout << "Usage: " << prog << " -c contigfile(s) -r readfile(s) [-m max_sort_char] [-s contig_sub_len] [-l max_search_loops]" << endl;
  cout << "          [-i min_cov_init] [-p min_overlap] [-t max_threads]" << endl;
  cout << "       " << prog << " -h" << endl;
  cout << endl;
