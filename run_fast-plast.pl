...
bowtie2 --very-sensitive-local --al map_hits.fq --al-conc map_pair_hits.fq -x Fast-Plast_master/Verdant -1 $3.trimmed_P1.fq -2 $3.trimmed_P2.fq -U $3.trimmed_U1.fq,$3.trimmed_U2.fq -S $3.sam
...
Fast-Plast-master/bin/plastome_finisher.sh $3 /home/mmckain/Andropogoneae_Plastomes/FINISHED/positional_genes.fsa
